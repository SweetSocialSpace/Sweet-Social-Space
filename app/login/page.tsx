      ...
      <div className="relative z-10 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-10 items-center">
        <div className="text-left">
          ...
          <p className="mt-4 text-base text-white/70 leading-relaxed">
            Sweet Social Space is private to neighbors within 10 miles of YOU — wherever you are in the world — LOCAL TO YOUR NEIGHBORHOOD • LIVE. No robots deciding what you see. No shadowbans for your faith. Just real neighbors, right now.
          </p>
        ...
        <div className="w-full bg-black/40 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl">
          ...
          <p className="text-white/80 text-center text-sm mb-6 mt-2 font-semibold">Your neighborhood missed you. LOCAL TO YOUR NEIGHBORHOOD • LIVE</p>
          ...
          <div className="text-white/20 uppercase tracking-widest text-center mt-4 text-sm">LOCAL TO YOUR NEIGHBORHOOD • FAILSAFE</div>
        </div>
      </div>
    </div>
  )
