    ...
    <div className="bg-white/[0.08] backdrop-blur-2xl rounded-2xl p-6 border border-white/15 shadow-2xl">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div>
          ...
          <p className="text-xs font-bold text-white/50">Posting as • YOUR BLOCK • Welcome</p>
        </div>
      </div>
      <h3 className="text-base font-black text-white leading-snug mb-2">🎉 You found us. Welcome to your private block.</h3>
      <p className="text-sm text-white/80 mb-4">This is YOUR space within 10 miles of you — not the whole internet.</p>
      ...
      <p className="text-xs font-bold text-white/50">No robots. No shadowbans. Faith welcome. Respect required.</p>
