      ...
      <div className="relative">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-white/50">{t?.welcome?.privateBlock ? tFormat(t.welcome.privateBlock, { area }) : `Your private block • ${area}`}</p>
          </div>
        </div>
        ...
        <p className="text-sm text-white/80 mb-4">{t?.welcome?.yourSpace ? tFormat(t.welcome.yourSpace, { area }) : `This is your space near ${area} — not the whole internet.`}</p>
