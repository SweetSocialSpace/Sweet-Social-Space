      ...
      <div className="max-w- mx-auto px-4 py-10">
        <div className="bg-black/60 backdrop-blur-xl rounded-2xl border border-white/10 p-8">
          ...
          {done? (
            ...
            <>
              <input value={org} onChange={e=>setOrg(e.target.value)} placeholder="Organization name (e.g. Austin Police, Denver Fire)" className="mt-6 w-full p-3 rounded-xl text-black" />
