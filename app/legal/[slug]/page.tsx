  ...
  guarantees: {
    ...
    content: (
      <>
        ...
        <h2>4. GLOBAL DETECTION</h2><p>IP detection first via ipapi.co/json — GLOBAL.</p>
        <h2>5. VERIFIED SOURCES LIVE</h2><p>Latest Alerts GLOBAL, WeatherBar, Verified Sources — Fire Station 3, 63.</p>
        <h2>6. SSL SECURED & PRIVATE</h2><p>Full SSL/TLS via Vercel, Supabase Auth RLS.</p>
        <h2>7. INDEPENDENT FAILSAFE</h2><p>Independent not Big Tech. Vertebrae independent.</p>
      </>
    )
  },
  security: { title: 'Security • SSL Secured', updated: 'July 27, 2026', content: <p>All https only. TLS 1.3 via Vercel. Supabase Auth RLS. Encrypted at rest. Report security@sweetsocialspace.com</p> },
  legal: { title: 'Legal • GLOBAL', updated: 'July 27, 2026', content: <p>DMCA legal@sweetsocialspace.com. Governing Law California. GLOBAL LIVE VERTEBRAE FAILSAFE.</p> },
  terms: { title: 'Terms of Service', updated: 'July 27, 2026', content: <p>Speak Freely Love Neighbor. Private 10 miles GLOBAL. You own content. Support support@sweetsocialspace.com</p> },
  privacy: { title: 'Privacy Policy', updated: 'July 27, 2026', content: <p>We collect zip, city, email only. IP via ipapi.co/json GLOBAL never hardwired 95122. No selling data. No Pixel. RLS Supabase.</p> },
  contact: { title: 'Contact Us', updated: 'July 27, 2026', content: <p>Support support@sweetsocialspace.com • Verification verification@sweetsocialspace.com</p> },
  about: { title: 'About • GLOBAL', updated: 'July 27, 2026', content: <p>Your block not world. 10 miles of YOU wherever you are GLOBAL.</p> }
}
