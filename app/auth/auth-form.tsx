...
export default function AuthForm() {
  ...
  return (
    <form onSubmit={handleAuth} className="space-y-4">
      ...
      <button type="submit" disabled={loading} className="w-full p-3 rounded bg-blue-600 hover:bg-blue-700 text-white font-bold disabled:opacity-50">{loading ? 'Loading...' : isSignUp ? 'Sign Up' : 'Sign In'}</button>
