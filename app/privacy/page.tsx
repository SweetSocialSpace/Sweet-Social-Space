        ...
        <div className="bg-black/40 rounded-xl border border-white/10 p-8 md:p-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-white/90">Email address for account creation. Content you choose to post publicly on Sweet Social Space.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-white/90">Delete your account and all associated data anytime from profile settings. Request data export: support@sweetsocialspace.com</p>
            </div>
          </div>
