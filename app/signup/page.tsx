          ...
          <form onSubmit={handleSignup} className="space-y-3">
            ...
            <div className="pt-2 border-t border-white/10">
              ...
              <div className="grid grid-cols-2 gap-3">
                <input type="text" value={zip} onChange={e=>setZip(e.target.value)} placeholder="Zip / Postal Code *" className="w-full p-3 rounded-xl bg-white text-black font-semibold col-span-2" required />
