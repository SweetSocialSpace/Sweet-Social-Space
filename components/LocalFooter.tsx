      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-8 text-sm">
        <div>
          ...
          <ul className="space-y-2 text-white/60">
            <li><Link href="/apply-verification" className="hover:text-white">Verification</Link></li>
            <li><Link href="/legal/security" className="hover:text-white">Security • SSL Secured</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-white/60">
            <li><Link href="/legal/terms" className="hover:text-white">Terms of Use</Link></li>
            <li><Link href="/legal/privacy" className="hover:text-white">Privacy Policy</Link></li>
            <li><Link href="/legal/legal" className="hover:text-white">Legal • DMCA</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="font-black text-white uppercase tracking-widest mb-3">Guarantees</h4>
          <ul className="space-y-2 text-white/60">
            <li><Link href="/legal/guarantees" className="hover:text-white">Our Guarantees</Link></li>
            <li><Link href="/faith" className="hover:text-white">Faith Corner</Link></li>
