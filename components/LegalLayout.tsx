  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative' }}>
      ...
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.1)', padding: '20px', textAlign: 'center', fontSize: '12px', color: '#aaa', background: 'rgba(0,0,0,0.32)' }}>
       © Sweet Social Space • SSL SECURED • <Link href="/legal/terms" style={{ marginLeft: '8px', color: '#ccc' }}>Terms</Link> • <Link href="/legal/privacy" style={{ marginLeft: '8px', color: '#ccc' }}>Privacy</Link> • <Link href="/legal/contact" style={{ marginLeft: '8px', color: '#ccc' }}>Contact</Link>
      </footer>
    </div>
  )
}
