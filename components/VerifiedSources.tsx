...
export function VerifiedSources({ compact = false }: { compact?: boolean }) {
              ...
              <li key={item.id}>
                <div className="block h-full rounded-2xl border border-border bg-background/60 p-4 transition hover:bg-secondary">
                  <div className="flex items-center gap-2 text-sm font-semibold">
                    ...
                    <span className="ml-auto inline-flex items-center gap-1 rounded-full bg-primary/10 px-2 py-0.5 text- font-semibold text-primary">
                      ✓ Verified
                    </span>
                  </div>
